...
export default function NavBar({ libraries }: { libraries: JellyfinLibrary[] }) {
  ...
  return (
    <>
      {/* Style injecté pour forcer le logo — résiste au reset Tailwind */}
      <style>{`
        .jw-logo-img {
        ...
        .jw-nav-link:hover { color: #ffffff !important; }
      `}</style>
      ...
      <header style={{
        ...
        <Link href="/" style={{ flexShrink: 0, display: "flex", alignItems: "center" }}>
          ...
          <img src="/logo.png" alt="JellyWorld" className="jw-logo-img" />
        </Link>
