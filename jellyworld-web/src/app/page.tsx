...
// 👤 1. Récupérer le premier utilisateur actif du serveur (pour avoir ses bibliothèques)
...
// 📂 2. Récupérer les vraies bibliothèques de cet utilisateur
...
// 🎬 3. Récupérer les films d'une bibliothèque spécifique via son ParentId
      ...
      <main className="px-6 md:px-12 py-8 max-w-7xl mx-auto space-y-16">
        ...
        {activeLibraries.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-20 bg-zinc-950/40 border border-dashed border-zinc-900 rounded-2xl text-center p-6">
            ...
            <p className="text-sm font-medium text-zinc-400">Aucune bibliothèque séparée trouvée.</p>
            <p className="text-xs text-zinc-600 mt-1 max-w-xs">
              L'API restreint l'accès aux dossiers racine. Vérifiez les permissions de votre clé API.
            </p>
          </div>
        ) : (
