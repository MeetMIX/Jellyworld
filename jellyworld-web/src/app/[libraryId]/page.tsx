...
async function fetchItems(
  ...
  const url = `${INTERNAL}/Users/${userId}/Items`
    ...
    + `&Fields=PrimaryImageAspectRatio,ImageTags,Overview,RunTimeTicks,UserData,PremiereDate`
    ...
    <div style={{ minHeight: "100vh", background: "var(--jw-bg)", color: "var(--jw-text-1)" }}>
      <main style={{ padding: "32px 40px 80px" }}>
        ...
        <div style={{ marginBottom: 20 }}>
          <h1 style={{ fontSize: 24, fontWeight: 900, textTransform: "uppercase", letterSpacing: "0.06em", margin: "0 0 4px" }}>
